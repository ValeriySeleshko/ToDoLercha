...
(function () {
  ...
  const I18N = {
    ...
    ru: {
      ...
      app_version_footer: 'Plan4U • Версия 0.2.0',
      ...
      cycle_toggle_widget: 'Виджет в шапке блокнота',
      cycle_toggle_widget_desc: 'Показывать день цикла и статус рядом с датой',
    ...
    uk: {
      ...
      app_version_footer: 'Plan4U • Версія 0.2.0',
      ...
      cycle_default_length_val: '{days} дн.',
      cycle_toggle_widget: 'Віджет у шапці блокнота',
      cycle_toggle_widget_desc: 'Показувати день циклу та статус поруч із датою',
    ...
    en: {
      ...
      app_version_footer: 'Plan4U • Version 0.2.0',
      ...
      cycle_toggle_widget: 'Header cycle widget',
      cycle_toggle_widget_desc: 'Show current cycle day and phase in top bar',
