...
public class PerfectPackExtractor
{
            ...
            for (int r = 0; r < rows; r++)
            {
                for (int c = 0; c < cols; c++)
                {
                    ...
                    using (Bitmap sticker = new Bitmap(cropW, cropH, PixelFormat.Format32bppArgb))
                    {
                        ...
                        // 1. Flood fill transparency from all 4 outer borders
                        ...
                        // 2. Find central sticker component and remove any neighbor specks
                        ...
                        // If multiple components, find the one closest to cell center or largest
...
# 1. Cats (7x7 = 49)
[PerfectPackExtractor]::Extract("Sticker_Cats.jpg", "assets\stickers\cats", "cat", 7, 7, 116, 1941, 123, 1950)

# 2. More Cats (7x7 = 49)
[PerfectPackExtractor]::Extract("Sticker_Cats1.jpg", "assets\stickers\more_cats", "more_cat", 7, 7, 33, 2019, 35, 2021)

# 3. Flora (Mushrooms & Flowers) (8x8 = 64)
[PerfectPackExtractor]::Extract("Sticker_Mushrooms.jpg", "assets\stickers\flora", "flora", 8, 8, 74, 1978, 74, 1988)

# 4. Guinea Pigs (7x7 = 49)
[PerfectPackExtractor]::Extract("Sticker_Svinki.jpg", "assets\stickers\pigs", "pig", 7, 7, 77, 1971, 51, 1984)
